...
CLOUD = pygame.image.load(os.path.join("Assets/Other", "cloud.png"))
        #pygame.image.load(os.path.join("pic juppiecat/cloud", "cloud1.png")),
        #pygame.image.load(os.path.join("pic juppiecat/cloud", "cloud2.png")),
        #pygame.image.load(os.path.join("pic juppiecat/cloud", "cloud3.png"))]

STONE = [pygame.image.load(os.path.join("Assets/obstruction", "stone1.png")),]
